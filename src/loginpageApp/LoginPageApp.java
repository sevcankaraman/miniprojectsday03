...
public class LoginPageApp {
    ...
    public static void start(){
        ...
        // 1-kullanıcıya işlem menusu gösterelım
        int select;
        do {
            ...
            switch (select){
                ...
                case 0:
                    ...
                    break;
                default:
                    System.out.println("hatalı giriş yaptınız,tekrar deneyınız!");
                    break;
            }

        }while(select!=0);

        //2- tüm userların ortak ozellıklerı olacak,user classı olusturalım
